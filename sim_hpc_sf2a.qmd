...
format: 
  pdf:
    ...
    number-depth: 2
    number-offset: [0, 0]
    pdf-engine: pdflatex  # <-- Use pdflatex instead of xelatex or lualatex
editor: visual
editor_options: 
...
results_list <- lapply(sim_params, function(params) {
  ...
  simulate_seroincidence(nrep = params$nrep, n_sim = 300, observed = min_half_sf2a_IgG, range = params$range)
})
