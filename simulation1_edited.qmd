...
df_xs_Niger_sonnei_IgG <- create_xs_data(
  df,
...
df_xs_Sierra_sonnei_IgG <- create_xs_data(
  df,
...
# Application
df_xs_USA_sonnei_IgG <- prepare_df_for_serocalculator(df_xs_USA_sonnei_IgG)
df_xs_Ghana_sonnei_IgG<- prepare_df_for_serocalculator(df_xs_Ghana_sonnei_IgG)
df_xs_Niger_sonnei_IgG<- prepare_df_for_serocalculator(df_xs_Niger_sonnei_IgG)
df_xs_Sierra_sonnei_IgG<- prepare_df_for_serocalculator(df_xs_Sierra_sonnei_IgG)
```
...
dL_clean <- process_shigella_data(data = df, study_filter = "SOSAR", antigen = n_sonneiospbsa_MFI)
