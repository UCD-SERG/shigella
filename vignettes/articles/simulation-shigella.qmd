---
title: Estimating Optimal Sample Size Through 300 Simulations
---
...
```{r}
load("/cloud/project/data/curve_params_shigella_ipab.rda")
load("/cloud/project/data/incidence_stats_ipab.rda")
```
...
results_list <- lapply(sim_params, function(params) {
  ...
  simulate_seroincidence2(nrep = params$nrep, n_sim = 300, observed = a, range = params$range) # choose observed value
})
