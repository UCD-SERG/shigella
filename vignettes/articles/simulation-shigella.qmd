...
```{r}
load("/cloud/project/data/curve_params_shigella_ipab.rda") # From the first .qmd file
load("/cloud/project/data/incidence_stats_ipab.rda") # From the second .qmd file
```
