...
Each sensitivity analysis names what it varies and what it would have shown had it failed (@tbl-ch2-sens).
...
figure per condition and scheme (@tbl-ch2-cov), which is where the two extremes
of @tbl-ch2-perparam become visible.
:::
