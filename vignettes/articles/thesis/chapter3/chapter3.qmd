...
The comparison against the established implementation is conceptual rather than numerical, because the two implementations differ in the noise convention, the density for time since infection, the handling of the never-infected branch, and the time units (@sec-ch3-design).
