...
We measured antibody responses against hemolysin E (HlyE).
...
The discordance reported above is the finding this chapter is least able to explain. If repeated infection is the cause, the single-infection framework itself, which every likelihood form considered here shares, is the next assumption to examine.
