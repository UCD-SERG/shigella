...
The joint form restores calibration at a constant cost in width.
...
Children under five carry lower concentrations and are censored more often, so the restriction that makes the correlation computable removes most of that band in three of the six sites and leaves it with too few participants to estimate anything.
