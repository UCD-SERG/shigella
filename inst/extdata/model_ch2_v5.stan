...
parameters {
  ...
  // correlation.
  vector[n_params] rho_c;  // unbounded: the (-1,1) cap is not required for positive definiteness and was binding on all five correlations                                   // cross-biomarker same-parameter covariances
