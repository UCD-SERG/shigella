...
get_dataset_for_sensitivity <- function(antigen, model, datasets) {
  key <- if (model == "overall") {
    c(Sonnei = "dL_clean_sonnei_new", Sf3a = "dL_clean_sf3a_new",
      Sf2a = "dL_clean_sf2a_new")[antigen]
  } else if (model == "serotype") {
    c(Sonnei = "dL_serotype_sonnei", Sf3a = "dL_serotype_sf3a",
      Sf2a = "dL_serotype_sf2a")[antigen]
  } else {
    NA_character_
  }
