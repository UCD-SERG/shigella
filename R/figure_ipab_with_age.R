...
.fig5_age_plot <- function(all_curves, indiv_data, antigen_label, log_y, xlim, overall_lab) { # nolint: line_length_linter.
  ...
  p <- p +
    ...
    ggplot2::theme(
      plot.title = ggplot2::element_text(face = "bold", size = 13, hjust = 0.5), # nolint: line_length_linter.
...
#' @return A ggplot.
#' @export
figure_ipab_with_age <- function(model_overall, model_under5, model_plus5,
                                 raw_overall,
