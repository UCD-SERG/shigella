# ==========================================================================
# phase1_single_diagnostic_n48.R
# ==========================================================================
...
if (compile_dir == "") {
  ...
  compile_dir <- file.path("/tmp", user, sprintf("cmdstan_bin_phase1_n48_%s", job_id))
}
...
out_file <- sprintf("outputs/phase1/one_fit_n48_jobid_%s.rds", job_id)
saveRDS(
  list(
    scenario   = "phase1_slurm_single_n48",
    status     = "FIT_STARTED",
    job_id     = job_id,
...
fit <- tryCatch({
  ...
  saveRDS(
    list(scenario = "phase1_slurm_single_n48", status = "FIT_FAILED",
         job_id = job_id,
...
phase0_file <- "outputs/phase0/one_fit_n48.rds"
