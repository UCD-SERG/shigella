...
results_list <- lapply(sim_params, function(params) {
  ...
  simulate_seroincidence(nrep = params$nrep, n_sim = 200, observed = min_half_ipab_IgG, range = params$range)
})
...
## Graphs of where the x axis is the sample size and the y axis is 
...
metrics_200_1 <- calculate_metrics(final_table_200_1, 100)
metrics_200_2 <- calculate_metrics(final_table_200_2, 100)

metrics_300_1 <- calculate_metrics(final_table_300_1, 100)
metrics_300_2 <- calculate_metrics(final_table_300_2, 100)

metrics_400_1 <- calculate_metrics(final_table_400_1, 100)
metrics_400_2 <- calculate_metrics(final_table_400_2, 100)
